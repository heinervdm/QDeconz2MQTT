...
int main(int argc, char *argv[]) {
  ...
  QObject::connect(&wsc, &WebSocketClient::messageReceived, &mc,
                   &MqttHandler::handleMessage);
  QObject::connect(&wsc, &WebSocketClient::closed, qApp,
                   &QCoreApplication::quit);
  QObject::connect(&mc, &MqttHandler::errorOccured, qApp,
                   &QCoreApplication::quit);

  wsc.initSensors(config.restApiPrefix());
